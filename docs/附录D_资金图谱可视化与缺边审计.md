...
<img src="./images/appendix_d_4379_loop_v2.png" alt="图 D-1 账户 4379 闭环回流" width="920" />
...
<img src="./images/appendix_d_1740_star_v2.png" alt="图 D-2 账户 1740 星状汇聚" width="920" />
...
<img src="./images/appendix_d_7265_star_v2.png" alt="图 D-3 账户 7265 星状试探" width="920" />
...
<img src="./images/appendix_d_9928_flow_v2.png" alt="图 D-4 Top30 账户 9928 双向回流" width="920" />

**说明：** 账户 9928 模型风险分 0.9797，进入 Top30 高风险巡检队列，标签为其它。3842、5584 与其在 2025-07、2025-08 反复互转，7/1 各入 4.5 万元、7/30 各入 30 万元、8/5 各出 60 万元、8/6 各出 30 万元；转入合计 690000 元、转出合计 1800000 元，转出规模显著放大，呈双向闭环回流/资金归集结构，属于值得人工复核的高风险关联网络。

## 图例与口径说明

节点颜色：**红色=确认嫌疑人，橙色=受害人，蓝色=其它**，颜色即代表账户标签，节点下方仅显示账户 ID 与模型风险分；橙色箭头=转入，蓝色箭头=转出；**每笔交易绘制一条有向边**，线宽=单笔金额（对数）。边描述嵌在边线内：文字沿弧线方向排版，无底框，弧线在文字处断开、以白色描边保证可读性，显示单笔时间与金额；同一对手的重复交易分居弧线两侧并用不同弧度错开，避免文字遮挡节点。所有图谱只使用截至测试期截止（2025-12-31）的历史交易，未使用未来交易。
...
- 图谱图片：`docs/images/appendix_d_4379_loop_v2.png`、`appendix_d_1740_star_v2.png`、`appendix_d_7265_star_v2.png`、`appendix_d_9928_flow_v2.png`
