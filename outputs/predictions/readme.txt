...
- model8_final_dynamic_fusion_v7_strategy_A.csv：动态图树融合模型（Dynamic Graph Tree Ensemble）预测
- model9_catboost_dynamic_v1_no_customer_type_strategy_A.csv：CatBoost
- model10_tgn_v1_no_customer_type_strategy_A.csv：轻量 TGN
- model11_validation_selected_best_strategy_A.csv：图-树-时序融合模型（Graph-Tree-Temporal Champion Fusion）预测
