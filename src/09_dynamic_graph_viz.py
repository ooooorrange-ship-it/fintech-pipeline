...
EVIDENCE_VIEW = """
  <main id="evidenceView" class="view wide">
    <div class="section-head"><div><h2>典型链路证据（测试集真实子图）</h2><p>仅展示本项目从测试集真实交易边生成的资金图谱，数据截至 2025-12-31，不含未来交易。节点颜色：红=确认嫌疑人，橙=受害人，蓝=其它；橙色箭头=转入，蓝色箭头=转出；每条线=一笔真实交易，线宽=单笔金额对数，边描述嵌在边线内（沿弧线排版，弧线在文字处断开，无底框）。</p></div></div>
